<?php
    ...
    require_once "../controllers/dailyLifeControl.php";
?>
    <title>Lunarpunk : Forum - Quotidien</title>
...
<main>
    <div id="subjects">
        <div id="subjectHeader">
            <h3>Forum - Quotidien</h3>
            <form action="../controllers/dailyLifeControl.php" method="post">
