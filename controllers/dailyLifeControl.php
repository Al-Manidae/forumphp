<?php
    ...
    $req = "SELECT discution.idDiscu, discution.nameDiscu, discution.timeStartDiscu, discution.idCat, discution.idUser, utilisateur.nomUser, utilisateur.prenomUser FROM discution JOIN utilisateur ON utilisateur.idUser=discution.idUser WHERE idCat=3 ORDER BY idDiscu DESC";
    $res = $con->query($req);
    $rows = $res->fetchAll();
